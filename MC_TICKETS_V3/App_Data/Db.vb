...
Public Class Db
    ...
    Public Shared Function Conectando() As String
        ...
        'conexion = "Server =" & DesEncriptarCadena(StrConexion(1)) & ";Database=" & DesEncriptarCadena(StrConexion(2)) & ";User Id=" & DesEncriptarCadena(StrConexion(3)) & ";Password=" & DesEncriptarCadena(StrConexion(4)) & ";Connection Timeout=90;"
        conexion = "Server =10.55.37.12;Database=MC_TICKETS;User Id=sa;Password=Enter83;Connection Timeout=90;"
